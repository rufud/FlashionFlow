  ...
  return (
    <div className="bg-[#1A1A1A] min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="max-w-sm w-full px-4 space-y-8"> 
        ...
        <form onSubmit={handleLogin} className="space-y-4 flex items-center  flex-col">
          <Input
            type="email"
            label="Email"
            value={email}
          ...
          />
          <Button type="submit" color="secondary" variant="solid" className="top-3 w-2/3 mx-auto font-bold" size="lg">
            Iniciar Sesión
          </Button>
        </form>
