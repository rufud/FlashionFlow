...
//       <Button onPress={() => navigate('/products/new')}>
...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-[#1A1A1A] min-h-screen flex flex-col items-center justify-center">
      <div className="flex items-center mb-20 px-4  top-0 ">
        <Image
        ...
        />
        <h1 className="text-4xl font-bold text-white">Fashion Flow</h1> 
      </div>

      <div className="max-w-sm w-full px-4 space-y-8 flex items-center  flex-col">
        <h2 className="text-2xl font-bold text-white text-center">Bienvenido a la gestión de productos</h2>

        <Button color="primary" onPress={() => navigate('/products')} size="lg">
          Ver Lista de Productos
        </Button>
        <Spacer y={0.5} />
        
        <Spacer y={40} />
        <Button  color="warning" onPress={handleLogout} size="lg"> {/* Color warning */}
          Cerrar Sesión
        </Button>
      </div>
    </div>
